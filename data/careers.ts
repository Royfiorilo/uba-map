...
{ source: 'med_fam1', target: 'iar_apap' },
  ...
  nutricion: {
    ...
    nodos: [
      ...
      // --- SEGUNDO AÑO ---
      { id: 'bnutri', nombre: 'Bioquímica de la Nutrición', ciclo: 'Segundo', x: 500, y: 0, categoria: 'obligatoria' },
      { id: 'ana_n', nombre: 'Anatomía', ciclo: 'Segundo', x: 500, y: 100, categoria: 'obligatoria' },
      { id: 'fisio_n', nombre: 'Fisiología', ciclo: 'Segundo', x: 500, y: 200, categoria: 'obligatoria' },
      { id: 'nutri_norm', nombre: 'Nutrición Normal', ciclo: 'Segundo', x: 500, y: 300, categoria: 'obligatoria' },
      { id: 'isp', nombre: 'Intro a la Salud Pública', ciclo: 'Segundo', x: 500, y: 400, categoria: 'obligatoria' },
      { id: 'socio_n', nombre: 'Socioantropología', ciclo: 'Segundo', x: 500, y: 500, categoria: 'obligatoria' },
      { id: 'estadi', nombre: 'Estadística', ciclo: 'Segundo', x: 500, y: 600, categoria: 'obligatoria' },

      // --- TERCER AÑO ---
      { id: 'fisiopato_n', nombre: 'Fisiopatología', ciclo: 'Tercer', x: 800, y: 0, categoria: 'obligatoria' },
      { id: 'tec_diet', nombre: 'Técnica Dietética', ciclo: 'Tercer', x: 800, y: 100, categoria: 'obligatoria' },
      { id: 'broma', nombre: 'Bromatología y Tec. Alim.', ciclo: 'Tercer', x: 800, y: 200, categoria: 'obligatoria' },
      { id: 'micro_n', nombre: 'Microbio. y Parasito.', ciclo: 'Tercer', x: 800, y: 300, categoria: 'obligatoria' },
      { id: 'niño_sano', nombre: 'Alim. del Niño Sano', ciclo: 'Tercer', x: 800, y: 400, categoria: 'obligatoria' },
      { id: 'comu', nombre: 'Desarrollo de la Comunidad', ciclo: 'Tercer', x: 800, y: 500, categoria: 'obligatoria' },
      { id: 'bioesta', nombre: 'Bioestadística', ciclo: 'Tercer', x: 1050, y: 600, categoria: 'obligatoria' },
      
      // --- CUARTO AÑO ---
      { id: 'psico_n', nombre: 'Psicología de la Nutrición', ciclo: 'Cuarto', x: 1300, y: 0, categoria: 'obligatoria' },
      { id: 'educ_n', nombre: 'Educación en Nutrición', ciclo: 'Cuarto', x: 1300, y: 100, categoria: 'obligatoria' },
      { id: 'adm_serv', nombre: 'Adm. Serv. Alimentación', ciclo: 'Cuarto', x: 1300, y: 200, categoria: 'obligatoria' },
      { id: 'epidemi', nombre: 'Epidemiología en Nutrición', ciclo: 'Cuarto', x: 1300, y: 300, categoria: 'obligatoria' },
      { id: 'dietot_n', nombre: 'Técnica Dietoterapica', ciclo: 'Cuarto', x: 1300, y: 400, categoria: 'obligatoria' },

      // --- QUINTO AÑO (PRÁCTICAS) ---
      { id: 'prac_sp', nombre: 'Prácticas Salud Pública', ciclo: 'Quinto', x: 1600, y: 150, categoria: 'obligatoria' },
      { id: 'prac_diet', nombre: 'Prácticas Dietoterapia', ciclo: 'Quinto', x: 1600, y: 250, categoria: 'obligatoria' }
    ],
    correlativas: [
      // CBC
      { source: 'mat', target: 'fis' }, { source: 'qui', target: 'bio' },
      // Segundo a Tercero
      { source: 'bnutri', target: 'fisiopato_n' }, { source: 'nutri_norm', target: 'fisiopato_n' },
      { source: 'ana_n', target: 'fisiopato_n' }, { source: 'fisio_n', target: 'fisiopato_n' },
      { source: 'bnutri', target: 'tec_diet' }, { source: 'nutri_norm', target: 'tec_diet' },
      ...
      // Filtro de 5to (Simbolizamos con las troncales de 4to)
